 ...
 * @author EDUARDO
 */
public class SinopsisPelicula1 extends javax.swing.JFrame {

    /** Creates new form SinopsisPelicula5 */
    public SinopsisPelicula1() {
        initComponents();
        setLocationRelativeTo(null);
        Lunes_cartelera ventana = new Lunes_cartelera();
        reseña1.setText(ventana.reseña1);
    ...
    private void initComponents() {
        ...
        reseña1 = new javax.swing.JTextPane();
        ...
        jScrollPane1.setViewportView(reseña1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 250, 180));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/usuario/CARTELERA/imagenes/fondos-de-pantalla-azul-infinito.jpg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 310, 360));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SinopsisPelicula1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SinopsisPelicula1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane reseña1;
