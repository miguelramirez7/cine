 ...
 * @author EDUARDO
 */
public class SinopsisPelicula4 extends javax.swing.JFrame {

    /**
     * Creates new form SinopsisPelicula4
     */
    public SinopsisPelicula4() {
        initComponents();
        setLocationRelativeTo(null);
        Lunes_cartelera ventana = new Lunes_cartelera();
        reseña4.setText(ventana.reseña4);
    }
    ...
    private void initComponents() {
        ...
        reseña4 = new javax.swing.JTextPane();
        ...
        jScrollPane1.setViewportView(reseña4);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SinopsisPelicula4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SinopsisPelicula4().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane reseña4;
