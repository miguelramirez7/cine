...
public class S2 extends javax.swing.JFrame {
    ...
    public S2() {
        ...
        setVisible(true);
        setTitle ( " LA ERA DE HIELO - PROXIMAMENTE ");
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(20, 370, 60, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectos/imagenes/era_de_hielo.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, -10, 970, 460);
