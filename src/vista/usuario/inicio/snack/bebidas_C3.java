...
public class bebidas_C3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSpinner4.setBounds(450, 190, 50, 30);

        jSpinner3.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jSpinner3.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        ...
        jSpinner3.setBounds(350, 190, 50, 30);

        jSpinner2.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jSpinner2.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        ...
        jSpinner2.setBounds(250, 190, 50, 30);
        ...
        jSpinner1.setBounds(150, 190, 50, 30);
        ...
        jSpinner5.setBounds(40, 190, 50, 30);
        ...
        jLabel1.setBounds(-20, 0, 580, 400);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bebidas_C3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bebidas_C3().setVisible(true);
            }
        });
    }
